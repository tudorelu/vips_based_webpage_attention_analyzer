...
public class Vips {
	...
	{
		System.out.println("Getting Dom Tree");
		...
		System.out.println("Done with dom tree");
	}
	...
	{
		System.out.println("Getting Viewport "+_domAnalyzer+_domAnalyzer.getRoot());
		_browserCanvas = new BrowserCanvas(_domAnalyzer.getRoot(),
				_domAnalyzer, new java.awt.Dimension(1000, 1000), _url);
		System.out.println("Got Canvas");
		_viewport = _browserCanvas.getViewport();
		System.out.println("Got Viewport");
	}
	...
	{
		System.out.println("Exporting Page to Image");
		try
		{
		...
		System.out.println("Done Exporting to Image");
	}
	...
	public void startSegmentation()
	{
		try
		{
			...
			System.out.println("Current read timeout: "+conn.getReadTimeout()+"ms; Setting it to 2000ms");
			conn.setConnectTimeout(10000);
			conn.setReadTimeout(10000);
			System.out.println("Sleep for 2 secs after _url.openConnection");
		...
		System.out.println("Getting viewport");
			getViewport();
			restoreOut();
		...
		System.out.println("perform segmentation");
			performSegmentation();
